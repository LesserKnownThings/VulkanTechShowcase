...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Multi-line Text Input"))
        {
            ...
            static char textWidget[1024 * 16] =
                "/*\n"
            ...
            ImGui::InputTextMultiline("##source", textWidget, IM_ARRAYSIZE(textWidget), ImVec2(-FLT_MIN, ImGui::GetTextLineHeight() * 16), flags);
            ImGui::TreePop();
        }
...
struct ExampleAssetsBrowser
{
    ...
    void AddItems(int instanceCount)
    {
        if (Items.Size == 0)
            NextItemId = 0;
        Items.reserve(Items.Size + instanceCount);
        for (int n = 0; n < instanceCount; n++, NextItemId++)
