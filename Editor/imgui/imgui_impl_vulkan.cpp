...
uint32_t ImGui_ImplVulkanH_SelectQueueFamilyIndex(VkPhysicalDevice physical_device)
{
    ...
    vkGetPhysicalDeviceQueueFamilyProperties(physical_device, &instanceCount, nullptr);
    ImVector<VkQueueFamilyProperties> queues_properties;
    queues_properties.resize((int)instanceCount);
    vkGetPhysicalDeviceQueueFamilyProperties(physical_device, &instanceCount, queues_properties.Data);
