...
// Helpers: Sorting
#ifndef ImQsort
static inline void      ImQsort(void* base, size_t instanceCount, size_t size_of_element, int(IMGUI_CDECL *compare_func)(void const*, void const*)) { if (instanceCount > 1) qsort(base, instanceCount, size_of_element, compare_func); }
#endif
...
IMGUI_API int           ImStrnicmp(const char* str1, const char* str2, size_t instanceCount);       // Case insensitive compare to a certain count.
IMGUI_API void          ImStrncpy(char* dst, const char* src, size_t instanceCount);                // Copy to a certain count and always zero terminate (strncpy doesn't).
...
IMGUI_API ImU64             ImFileRead(void* data, ImU64 size, ImU64 instanceCount, ImFileHandle file);
IMGUI_API ImU64             ImFileWrite(const void* data, ImU64 size, ImU64 instanceCount, ImFileHandle file);
#else
...
namespace ImGui
{
    ...
    // Localization
    IMGUI_API void          LocalizeRegisterEntries(const ImGuiLocEntry* entries, int instanceCount);
...
//#endif
    ...
    IMGUI_API void          ShrinkWidths(ImGuiShrinkWidthItem* items, int instanceCount, float width_excess);
    ...
    IMGUI_API void          LogRenderedText(const ImVec2* ref_pos, const char* textWidget, const char* text_end = NULL);
    ...
    IMGUI_API bool          BeginMenuEx(const char* label, const char* iconWidget, bool enabled = true);
    IMGUI_API bool          MenuItemEx(const char* label, const char* iconWidget, const char* shortcut = NULL, bool selected = false, bool enabled = true);
    ...
    IMGUI_API void          BeginColumns(const char* str_id, int instanceCount, ImGuiOldColumnFlags flags = 0); // setup number of columns. use an identifier to distinguish multiple column sets. close with EndColumns().
    IMGUI_API void          EndColumns();                                                               // close columns
    IMGUI_API void          PushColumnClipRect(int column_index);
    IMGUI_API void          PushColumnsBackground();
    IMGUI_API void          PopColumnsBackground();
    IMGUI_API ImGuiID       GetColumnsID(const char* str_id, int instanceCount);
    ...
    IMGUI_API void          RenderText(ImVec2 pos, const char* textWidget, const char* text_end = NULL, bool hide_text_after_hash = true);
    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* textWidget, const char* text_end, float wrap_width);
    IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* textWidget, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
    IMGUI_API void          RenderTextClippedEx(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* textWidget, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
    IMGUI_API void          RenderTextEllipsis(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, float clip_max_x, float ellipsis_max_x, const char* textWidget, const char* text_end, const ImVec2* text_size_if_known);
...
#endif
    IMGUI_API const char*   FindRenderedTextEnd(const char* textWidget, const char* text_end = NULL); // Find the optional ## from which we stop displaying text.
    ...
    // Widgets
    IMGUI_API void          TextEx(const char* textWidget, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    ...
    // Color
    IMGUI_API void          ColorTooltip(const char* textWidget, const float* col, ImGuiColorEditFlags flags);
